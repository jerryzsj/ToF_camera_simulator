...
float preset_cam_diatance = 200.0;
...
{    
    ...
    Kinect* myKinect = new Kinect(preset_cam_diatance); // set distance between Kinect and cooridinate-origin to be 200mm
    ...
    for(int i =0; i<num_samples; ++i)
    {
        ...
        // calculate interaction and save pcd
...
{
    cout << "Usage: ./three_cam_D200 NUM_SAMPLE FILELIST" << endl;
